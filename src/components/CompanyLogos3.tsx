...
const SwipeableSlider: React.FC = () => {
  ...
  const slides = [
    { src: "/partners/orders/Hunger.webp", alt: "Urpay" },
    { src: "/partners/orders/Jahez.webp", alt: "Mada" },
    { src: "/partners/orders/Mrsool.webp", alt: "Geidea" },
    { src: "/partners/orders/Ninja.webp", alt: "Alrajhi" },
    { src: "/partners/orders/Chefz.webp", alt: "STC Pay" },
    { src: "/partners/orders/To_You.webp", alt: "Zatka" },
  ];
