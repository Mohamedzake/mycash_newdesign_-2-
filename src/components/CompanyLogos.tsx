...
const SwipeableSlider: React.FC = () => {
  ...
  const slides = [
    { src: "/partners/banks/Alrajhi.webp", alt: "Urpay" },
    { src: "/partners/banks/commerce.webp", alt: "Mada" },
    { src: "/partners/banks/Monsha_at.webp", alt: "Geidea" },
    { src: "/partners/banks/SIB.webp", alt: "Alrajhi" },
    { src: "/partners/banks/SNB.webp", alt: "STC Pay" },
    { src: "/partners/banks/Zakat.webp", alt: "Zatka" },
  ];
